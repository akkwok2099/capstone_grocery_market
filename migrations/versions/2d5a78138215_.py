...
Revision ID: 2d5a78138215
Revises:
Create Date: 2020-12-14 16:04:36.426197
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            autoincrement=False, nullable=True),
        sa.Column(
            'is_cancelled', sa.BOOLEAN(), server_default=sa.text('false'),
            autoincrement=False, nullable=False),
        ...
        sa.PrimaryKeyConstraint(
            'id', 'product_id', name='purchases_pkey')
    )
    op.create_table(
        'providesdelivery',
        sa.Column(
        ...
        sa.Column(
            'supplier_id', sa.INTEGER(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ['supplier_id'], ['suppliers.id'],
            name='providesdelivery_supplier_id_fkey'),
        sa.PrimaryKeyConstraint(
            'delivery_id', name='providesdelivery_pkey'),
        postgresql_ignore_search_path=False
    )
    op.create_table(
        'departments',
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            autoincrement=False, nullable=False),
        sa.Column(
            'price_per_cost_unit', postgresql.DOUBLE_PRECISION(precision=53),
            autoincrement=False, nullable=False),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            autoincrement=False, nullable=False),
        sa.Column(
            'department_id', sa.BIGINT(), autoincrement=False, nullable=True),
        sa.Column(
            'title', sa.VARCHAR(length=255),
            autoincrement=False, nullable=True),
        sa.Column(
            'emp_number', sa.BIGINT(), autoincrement=False, nullable=False),
        sa.Column(
